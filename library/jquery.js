...
(function(a, b) {
    ...
    for (; i < j && (k || !l); i++)
      (l = h[i](c, d, e)),
        typeof l === "string" &&
          (g[l]
            ? (l = b)
            : (c.dataTypes.unshift(l), (l = bG(a, c, d, e, l, g))));
  ...
  (function() {
    ...
    if (e && e.length && f) {
      (d.support = {
        ...
        (d.support.scriptEval = function() {
          if (d.support._scriptEval === null) {
            ...
            b.insertBefore(e, b.firstChild),
              a[f]
                ? ((d.support._scriptEval = !0), delete a[f])
                : (d.support._scriptEval = !1),
              b.removeChild(e),
              (b = e = f = null);
          }
      ...
      b.attachEvent &&
        b.fireEvent &&
        (b.attachEvent("onclick", function j() {
          ...
          if ((c in a || a[c] !== b) && g && !i) {
            ...
            if (c === "tabIndex") {
              ...
              return o && o.specified
                ? o.value
                : l.test(a.nodeName) || (m.test(a.nodeName) && a.href)
                ? 0
                : b;
            }
            return a[c];
    ...
    add: function(c, e, f, g) {
      if (c.nodeType !== 3 && c.nodeType !== 8) {
        ...
        var k = j[u],
          l = j.handle;
        typeof k === "function"
          ? ((l = k.handle), (k = k.events))
          : k ||
            (c.nodeType || (j[u] = j = function() {}), (j.events = k = {})),
          l ||
            (j.handle = l = function() {
              return typeof d !== "undefined" && !d.event.triggered
                ? d.event.handle.apply(l.elem, arguments)
                : b;
            }),
          (l.elem = c),
          (e = e.split(" "));
        var m,
          ...
          o;
        while ((m = e[n++])) {
          (i = h ? d.extend({}, h) : { handler: f, data: g }),
            m.indexOf(".") > -1
              ? ((o = m.split(".")),
                (m = o.shift()),
                (i.namespace = o
          ...
          if (!p) {
            ...
            if (!q.setup || q.setup.call(c, g, o, l) === !1)
              c.addEventListener
                ? c.addEventListener(m, l, !1)
                : c.attachEvent && c.attachEvent("on" + m, l);
          }
          q.add &&
            (q.add.call(c, i), i.handler.guid || (i.handler.guid = f.guid)),
            p.push(i),
            (d.event.global[m] = !0);
        }
        c = null;
    ...
    remove: function(a, c, e, f) {
      if (a.nodeType !== 3 && a.nodeType !== 8) {
        ...
        var g,
          ...
          w = s && s[u];
        if (!s || !w) return;
        typeof w === "function" && ((s = w), (w = w.events)),
    ...
    trigger: function(a, c, e) {
      ...
      if (!a.isPropagationStopped() && i) d.event.trigger(a, c, i, !0);
        ...
        var k,
          ...
          p = d.event.special[m] || {};
        if (
          (!p._default || p._default.call(e, a) === !1) &&
          !n &&
  ...
  d.each(["live", "die"], function(a, c) {
    ...
    (function() {
      ...
      var i = function(b, d, e, g) {
        ...
        if (x.length > 1 && k.exec(b))
          ...
          !g &&
            ...
            !w &&
            j.match.ID.test(x[0]) &&
            !j.match.ID.test(x[x.length - 1]) &&
            ((q = i.find(x.shift(), d, w)),
          ...
          if (v)
            if (d && d.nodeType === 1)
              for (u = 0; o[u] != null; u++)
                o[u] &&
                  (o[u] === !0 ||
                    (o[u].nodeType === 1 && i.contains(d, o[u]))) &&
                  e.push(m[u]);
            else
              for (u = 0; o[u] != null; u++)
      ...
      for (var m in j.match)
        (j.match[m] = new RegExp(
          j.match[m].source + /(?![^\[]*\])(?![^\(]*\))/.source
        )),
          (j.leftMatch[m] = new RegExp(
      ...
      c.documentElement.compareDocumentPosition
          ...
          for (var d = 0; a[d]; d++)
            (c = a[d]),
              c.nodeType === 3 || c.nodeType === 4
                ? (b += c.nodeValue)
                : c.nodeType !== 8 && (b += i.getText(c.childNodes));
          return b;
        }),
        (function() {
          var a = c.createElement("div"),
        ...
        (function() {
          ...
          b &&
            (i.matchesSelector = function(a, c) {
              c = c.replace(/\=\s*([^'"\]]*)\s*\]/g, "='$1']");
              if (!i.isXML(a))
                try {
    ...
    load: function(a, b, c) {
      ...
      b &&
        (d.isFunction(b)
          ? ((c = b), (b = null))
          : typeof b === "object" &&
            ((b = d.param(b, d.ajaxSettings.traditional)), (g = "POST")));
      var h = this;
      d.ajax({
        url: a,
        type: g,
      ...
      return this.map(function() {
        ...
        .filter(function() {
          return (
            this.name &&
            !this.disabled &&
            (this.checked || by.test(this.nodeName) || bt.test(this.type))
          );
        })
        .map(function(a, b) {
          var c = d(this).val();
      ...
      ajax: function(a, e) {
        function w(a, c, e, l) {
          if (t !== 2) {
            ...
            (v.status = a),
              ...
              (k = b),
              f.global &&
                h.trigger("ajax" + (n ? "Success" : "Error"), [
                  v,
                  f,
                  n ? q : r
                ]),
        ...
        i.promise(v),
          ...
          (f.dataTypes = d
            ...
            .split(bz)),
          f.crossDomain ||
            ((s = bB.exec(f.url.toLowerCase())),
            (f.crossDomain =
              s &&
              (s[1] != r ||
                s[2] != q.hostname ||
                (s[3] || (s[1] === "http:" ? 80 : 443)) !=
                  (q.port || (r === "http:" ? 80 : 443))))),
          f.data &&
            f.processData &&
  ...
  d.ajaxSetup({
    ...
    d.ajaxPrefilter("json jsonp", function(b, c, e) {
      ...
      if (
        ...
        c.jsonpCallback ||
        c.jsonp != null ||
        (b.jsonp !== !1 && (bL.test(b.url) || (e && bL.test(b.data))))
      ) {
        var f,
          g = (b.jsonpCallback = d.isFunction(b.jsonpCallback)
            ? b.jsonpCallback()
            : b.jsonpCallback),
          h = a[g],
          i = b.url,
    ...
    d.ajaxTransport("script", function(a) {
      if (a.crossDomain) {
        var d,
          e = c.getElementsByTagName("head")[0] || c.documentElement;
        return {
          send: function(f, g) {
              ...
              g.send((b.hasContent && b.data) || null),
                (c = function(a, e) {
                  if (c && (e || g.readyState === 4)) {
                    (c = 0),
                      h && ((g.onreadystatechange = d.noop), delete bN[h]);
                ...
                b.async && g.readyState !== 4
                  ? ((h = bM++), (bN[h] = g), (g.onreadystatechange = c))
                  : c();
            },
            abort: function() {
              c && c(0, 1);
      ...
      for (var g = 0, h = this.length; g < h; g++)
        (e = this[g]),
          ...
          f === "" &&
            ...
            d._data(e, "olddisplay", bX(e.nodeName));
      for (g = 0; g < h; g++) {
      ...
      custom: function(a, b, c) {
        ...
        (this.startTime = d.now()),
          ...
          g() &&
            d.timers.push(g) &&
            !bU &&
            (bU = setInterval(f.tick, f.interval));
      },
      show: function() {
    ...
    d.fn.extend({
      position: function() {
        ...
        var a = this[0],
          b = this.offsetParent(),
          c = this.offset(),
          e = bZ.test(b[0].nodeName) ? { top: 0, left: 0 } : b.offset();
